...
// 11. TECHNICAL DETAILS POPOVER INTERACTIVE LOGIC
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btn && popover) {
        ...
        document.addEventListener('click', (e) => {
            if (isLocked && !popover.contains(e.target) && e.target !== btn) {
                isLocked = false;
                popover.classList.remove('active');
                btn.style.borderColor = '';
                btn.style.boxShadow = '';
        ...
        // Tabs logic
        const tabs = popover.querySelectorAll('.popover-tabs button');
        ...
        tabs.forEach(tab => {
            tab.addEventListener('click', (e) => {
                ...
                tabs.forEach(t => {
                    t.classList.remove('popover-tabactive');
                    t.classList.add('popover-tab');
                });
                tab.classList.remove('popover-tab');
                tab.classList.add('popover-tabactive');
